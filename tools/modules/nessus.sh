...
function install_nessus() {
    if $INSTALL_NESSUS; then
        ...
        _Curl "https://www.tenable.com/downloads/api/v1/public/pages/nessus/downloads/$LATEST_NESSUS/download?i_agree_to_tenable_license_agreement=true" "$TOOL_DIR/nessus/nessus.deb"
        # Install Nessus
        dpkg -i $TOOL_DIR/nessus/nessus.deb
    fi
